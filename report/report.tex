...
In the last years the Internet has changed a lot. 
It is not about retrieving simple html pages from websites anymore, but rather sharing news, videos and pictures from all over the world.
With the advent of the "Web 2.0" user-generated content has become a crucial part of the Internet we know nowadays.
% It would be nice to have a link to some kind of report comparing multimedia/web2.0 traffic
