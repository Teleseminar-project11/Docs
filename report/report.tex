...
As seen in Figure~\ref{fig:ui_main} and ~\ref{fig:ui_metadata} the user interface can be divided into two main parts: the starting point of the application and the actual camera recording application.
...
\begin{figure}[!t]
	\centering
	\includegraphics[width=0.45\textwidth]{ui_main.png}
