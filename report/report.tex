...
\author{Alexander Egurnov,~University~of~Mannheim\\
        Thilo Weigold,~University~of~Mannheim\\
        Jon Pettersen,~University~of~Oslo\\
		Alf-André Walla,~University~of~Oslo\\
}
...
% The paper headers
\markboth{Automatic Mobile Video Director}{}%
...
\IEEEtitleabstractindextext{%
	...
	\begin{IEEEkeywords}
	Mobile video, decision making, crowd sourcing, client-server.
	\end{IEEEkeywords}
}
...
\begin{description}
	...
	\item[PUT /event/\textit{id}/\textit{video\_id}]\hfill\\
	...
	\item[GET /event/\textit{id}/\textit{video\_id}]\hfill\\
...
\begin{description}
	...
	\item[resolution]\hfill\\
		...
		%TODO It is String now. Does switching to two integers make sense? 
		%	Does Java has built-in pair class like in c++?
