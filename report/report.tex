...
The server was built using Java 8, Maven, Spark and Gson. Maven allows easy instant deployment to new locations,
and Spark allows to create RESTful service using the new Java 8 lambdas, which simplifies and concentrates all the client-server
