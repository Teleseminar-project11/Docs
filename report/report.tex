...
The client application's design consists of four main logical components: 1. User Interface, 2. HTTP connection, 3. camera and sensor retrieving and 4. the persistent database.
...
we use the HttpURLConnection Client, which is lightweight, simple to handle as well as applicable for all purposes we are aiming to do. "Reference to android-developers.blogspot".
