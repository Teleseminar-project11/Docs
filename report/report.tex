...
Per settings it is possible to define the ip address and port number of the server and network communications.

\begin{figure}[!t]
	\centering
	\subfloat[Main]{\includegraphics[width=.2\textwidth]{ui_main.png}%
		\label{fig:ui_main}}
	\hfil
	\subfloat[Settings]{\includegraphics[width=.2\textwidth]{ui_interface.png}%
...
\begin{figure}[!t]
	\centering
	\subfloat[Camera]{\includegraphics[width=.4\textwidth]{ui_cam_green.png}%
		\label{fig:ui_cam_green}}
	\vfil
	\subfloat[Metadata upload]{\includegraphics[width=.4\textwidth]{ui_metadata.png}%
...
%\begin{figure}[!t]
	%\centering
	%\includegraphics[width=0.25\textwidth]{ui_main.png}
	%\caption{Application's starting point}
	%\label{fig:ui_main}
%\end{figure}
%
%\begin{figure}[!t]
	%\centering
	%\includegraphics[width=0.45\textwidth]{ui_metadata.png}
	%\caption{Transfering of meta data}
	%\label{fig:ui_metadata}
%\end{figure}
