...
Figure~\ref{fig:mediarecorder} shows the supposed behavior of the MediaRecoder in its different states. The function prepareMediaRecorder() (CameraActivity.java) follows the supposed main strand,
...
After preparing the MediaRecorder it is ready for starting the recording, which is triggered in the recordListener().
