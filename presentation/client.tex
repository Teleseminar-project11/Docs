\begin{frame}	
	...
	\begin{columns}[t]
		...
		\begin{column}[t]{0.5\linewidth}
			\begin{figure}[!t]
				\centering
				\includegraphics[width=\textwidth,height=.9\textheight,keepaspectratio]{http.jpg}
				\label{fig:gen_arch}
			\end{figure}
...
\begin{frame}	
	...
	\begin{columns}[t]
		...
		\begin{column}[t]{0.5\linewidth}
			\begin{figure}[!t]
				\centering
				\includegraphics[width=\textwidth,height=.9\textheight,keepaspectratio]{camera.jpg}
				\label{fig:gen_arch}
			\end{figure}
...
\begin{frame}	
	...
	\begin{columns}[t]
		...
		\begin{column}[t]{0.5\linewidth}
			\begin{figure}[!t]
				\centering
				\includegraphics[width=\textwidth,height=.9\textheight,keepaspectratio]{sqlite.jpg}
				\label{fig:gen_arch}
			\end{figure}
		\end{column}
	\end{columns}		
